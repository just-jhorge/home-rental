	...
	return (
		<section className="my-10 md:my-20">
			<div className="container mx-auto">
				<h1 className="capitalize text-center md:text-left font-bold text-xl md:text-3xl mb-5 md:mb-10">
					<span className="md:border-b-4 border-orange-600">
						minimum living cost
					</span>{" "}
					takes care of everything
				</h1>
				<div className="grid grid-cols-1 md:grid-cols-3 items-center md:gap-20">
					...
					<div className="col-span-2 py-8 md:py-14 grid grid-cols-2 md:grid-cols-3 grid-rows-3 md:grid-rows-2 gap-5 md:gap-y-14">
